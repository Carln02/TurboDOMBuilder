 ...
 * @extends TurboElement
 */
let DropdownEntry = class DropdownEntry extends TurboElement {
    _value;
    _selected = false;
    _selectedClass = "";
    /**
 ...
 * @extends TurboElement
 */
let Dropdown = class Dropdown extends TurboElement {
