...
import { AbstractType, Map as Map$1, Array as Array$1, YMapEvent, YArrayEvent, Doc } from 'yjs';
...
let TurboYBlock = (() => {
    ...
    return class TurboYBlock extends _classSuper {
        ...
        get(key) {
            if (!this.data || typeof this.data !== "object")
                return;
            if (this.data instanceof Map$1)
                return this.data.get(key.toString());
            if (this.data instanceof Array$1)
        ...
        set(key, value) {
            ...
            else if (this.data instanceof Array$1) {
        ...
        delete(key) {
            ...
            else if (this.data instanceof Array$1 && typeof key === "number" && key >= 0 && key < this.size)
