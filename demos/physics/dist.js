  ...
  ***************************************************************************** */
  ...
  let Bucket = (() => {
      ...
      return class Bucket extends _classSuper {
          ...
          _color = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, __color_initializers, new Color())); //Signal to fire @effect callbacks when the value changes
