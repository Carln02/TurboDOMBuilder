(function () {
      ...
      return function (value, context) {
          ...
          context.addInitializer(function () {
              ...
              if (kind === "field" || kind === "accessor") {
                  ...
                  const installed = utils$e.constructorData(prototype).installed;
  ...
  const utils$d = new HierarchyFunctionsUtils();
      ...
      Object.defineProperty(TurboSelector.prototype, "childHandler", {
          set: function (value) {
              if (value instanceof TurboSelector)
                  value = value.element;
              utils$d.data(this).childHandler = value;
          },
          get: function () {
              const childHandler = utils$d.data(this).childHandler;
              if (childHandler)
                  return childHandler;
  ...
  const utils$c = new ClassFunctionsUtils();
  function setupClassFunctions() {
      ...
      TurboSelector.prototype.addClass = function _addClass(classes) {
          if (!(this.element instanceof Element))
              return this;
          return utils$c.operateOnClasses(this, classes, entry => this.element.classList.add(entry));
      };
      /**
      ...
      TurboSelector.prototype.removeClass = function _removeClass(classes) {
          if (!(this.element instanceof Element))
              return this;
          return utils$c.operateOnClasses(this, classes, entry => this.element.classList.remove(entry));
      };
      /**
      ...
      TurboSelector.prototype.toggleClass = function _toggleClass(classes, force) {
          if (!(this.element instanceof Element))
              return this;
          return utils$c.operateOnClasses(this, classes, entry => this.element.classList.toggle(entry, force));
      };
      /**
  ...
  ***************************************************************************** */
  ...
  const utils$b = new ReactivityUtils();
  const signalUtils = new SignalUtils(utils$b);
  const effectUtils = new EffectUtils(utils$b);
  function signal(...args) {
      ...
      if (typeof args[0] === "function" && typeof args[1] === "function") {
          ...
          const key = keys.length === 1 ? keys[0] : keys.length > 1 ? utils$b.serializePath(keys) : undefined;
          return signalUtils.createBoxFromEntry(utils$b.createSignalEntry(undefined, target, key, get, set));
      }
      // From value: signal(initial?, target?, ...keys)
      const [initial, target, ...keys] = args;
      const key = keys.length === 1 ? keys[0] : keys.length > 1 ? utils$b.serializePath(keys) : undefined;
      return signalUtils.createBoxFromEntry(utils$b.createSignalEntry(initial, target, key));
  }
  function effect(...args) {
      ...
      if (context && typeof context === "object" && "kind" in context
          ...
          context.addInitializer?.(function () {
              ...
              utils$b.setEffect(self, key, eff);
          });
      }
  ...
  function initializeEffects(target) {
      for (const [, entry] of utils$b.data(target).propertyKeyMap)
          entry.effect?.run();
  }
  ...
  const utils$a = new MvcFunctionsUtils();
  ...
  function setupMvcFunctions() {
      ...
      Object.defineProperty(TurboSelector.prototype, "model", {
          get() {
              return utils$a.peek(this.element)?.model;
          },
          set(value) {
              if (!this.element)
                  return;
              const mvc = utils$a.data(this.element);
              utils$a.attachModel(this.element, this.model, false);
              utils$a.updateModel(this.element, mvc.model, false);
              mvc.model = utils$a.generateInstance(value);
              utils$a.attachModel(this.element, mvc.model);
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "view", {
          get() {
              return utils$a.peek(this.element)?.view;
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.data(this.element).view = utils$a.generateInstance(value, this.element);
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "emitter", {
          get() {
              return utils$a.peek(this.element)?.emitter;
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.data(this.element).emitter = utils$a.generateInstance(value);
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      ...
      Object.defineProperty(TurboSelector.prototype, "data", {
          get() {
              return utils$a.peek(this.element)?.model?.data;
          },
          set(value) {
              if (!this.element)
                  return;
      ...
      Object.defineProperty(TurboSelector.prototype, "dataId", {
          get() {
              return utils$a.peek(this.element)?.model?.id;
          },
          set(value) {
              if (!this.element)
                  return;
      ...
      Object.defineProperty(TurboSelector.prototype, "dataSize", {
          get() {
              return utils$a.peek(this.element)?.model?.size;
          },
          configurable: true, enumerable: true,
      });
      // -------------------------------------------------------------------------
      ...
      Object.defineProperty(TurboSelector.prototype, "controllers", {
          get() {
              return Array.from(utils$a.peek(this.element)?.controllers.values() ?? []);
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.generateInstances(value, this.element).forEach(instance => this.addController(instance));
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "handlers", {
          get() {
              return Array.from(utils$a.peek(this.element)?.model?.handlers.values() ?? []);
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.generateInstances(value).forEach(instance => this.addHandler(instance));
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "interactors", {
          get() {
              return Array.from(utils$a.peek(this.element)?.interactors.values() ?? []);
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.generateInstances(value, this.element).forEach(instance => this.addInteractor(instance));
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "tools", {
          get() {
              return Array.from(utils$a.peek(this.element)?.tools.values() ?? []);
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.generateInstances(value, this.element).forEach(instance => this.addTool(instance));
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      Object.defineProperty(TurboSelector.prototype, "substrates", {
          get() {
              return Array.from(utils$a.peek(this.element)?.substrates.values() ?? []);
          },
          set(value) {
              if (!this.element)
                  return;
              utils$a.generateInstances(value, this.element).forEach(instance => this.addSubstrate(instance));
              utils$a.linkPieces(this.element);
          },
          configurable: true, enumerable: true,
      });
      ...
      TurboSelector.prototype.initializeMvc = function () {
          if (!this.element)
              return this;
          const mvc = utils$a.peek(this.element);
          if (!mvc)
              return this;
          mvc.view?.initialize();
      ...
      TurboSelector.prototype.getController = function (key) {
          return utils$a.peek(this.element)?.controllers.get(key);
      };
      TurboSelector.prototype.addController = function (controller) {
          ...
          if (!controller.keyName)
              controller.keyName =
                  utils$a.extractClassEssenceName(this.element, controller.constructor, "Controller");
          utils$a.data(this.element).controllers.set(controller.keyName, controller);
          utils$a.updateController(this.element, controller);
          return this;
      };
      TurboSelector.prototype.removeController = function (keyOrInstance) {
          if (!this.element)
              return this;
          utils$a.removeInstance(this.element, "controller", keyOrInstance);
          return this;
      };
      TurboSelector.prototype.getHandler = function (key) {
          return utils$a.peek(this.element)?.model?.handlers.get(key);
      };
      TurboSelector.prototype.addHandler = function (handler) {
          ...
          if (!handler.keyName)
              handler.keyName =
                  utils$a.extractClassEssenceName(this.element, handler.constructor, "Handler");
          utils$a.data(this.element).model?.handlers.set(handler.keyName, handler);
          utils$a.updateHandler(this.element, handler);
          return this;
      };
      TurboSelector.prototype.removeHandler = function (keyOrInstance) {
          if (!this.element)
              return this;
          utils$a.removeInstance(this.element, "handler", keyOrInstance);
          return this;
      };
      TurboSelector.prototype.getInteractor = function (key) {
          return utils$a.peek(this.element)?.interactors.get(key);
      };
      TurboSelector.prototype.addInteractor = function (interactor) {
          ...
          if (!interactor.keyName)
              interactor.keyName =
                  utils$a.extractClassEssenceName(this.element, interactor.constructor, "Interactor");
          utils$a.data(this.element).interactors.set(interactor.keyName, interactor);
          utils$a.updateInteractor(this.element, interactor);
          return this;
      };
      TurboSelector.prototype.removeInteractor = function (keyOrInstance) {
          if (!this.element)
              return this;
          utils$a.removeInstance(this.element, "interactor", keyOrInstance);
          return this;
      };
      TurboSelector.prototype.getTool = function (key) {
          return utils$a.peek(this.element)?.tools.get(key);
      };
      TurboSelector.prototype.addTool = function (tool) {
          ...
          if (!tool.keyName)
              tool.keyName =
                  utils$a.extractClassEssenceName(this.element, tool.constructor, "Tool");
          utils$a.data(this.element).tools.set(tool.keyName, tool);
          utils$a.updateTool(this.element, tool);
          return this;
      };
      TurboSelector.prototype.removeTool = function (keyOrInstance) {
          if (!this.element)
              return this;
          utils$a.removeInstance(this.element, "tool", keyOrInstance);
          return this;
      };
      TurboSelector.prototype.getSubstrate = function (key) {
          return utils$a.peek(this.element)?.substrates.get(key);
      };
      TurboSelector.prototype.addSubstrate = function (substrate) {
          ...
          if (!substrate.keyName)
              substrate.keyName =
                  utils$a.extractClassEssenceName(this.element, substrate.constructor, "Substrate");
          utils$a.data(this.element).substrates.set(substrate.keyName, substrate);
          utils$a.updateSubstrate(this.element, substrate);
          return this;
      };
      TurboSelector.prototype.removeSubstrate = function (keyOrInstance) {
          if (!this.element)
              return this;
          utils$a.removeInstance(this.element, "substrate", keyOrInstance);
          return this;
      };
  }

  const utils$9 = new ElementFunctionsUtils();
  function setupElementFunctions() {
      ...
      TurboSelector.prototype.feedforward = function _feedforward(properties = {}) {
          ...
          const feedforwardElements = utils$9.data(this.element).feedforwardElements;
      ...
      Object.defineProperty(TurboSelector.prototype, "defaultFeedforwardProperties", {
          get: function () {
              ...
              return utils$9.data(this.element).defaultFeedforwardProperties;
          },
          set: function (value) {
              if ("defaultFeedforwardProperties" in this.element)
                  this.element.defaultFeedforwardProperties = value;
              utils$9.data(this.element).defaultFeedforwardProperties = value;
          },
          configurable: true,
          enumerable: true
      });
  ...
  const utils$8 = new ListenerUtils();
  /**
   * @decorator
  ...
  function attachListenersAndBehaviors(context) {
      if (!context || typeof context !== "object")
          return;
      const listeners = utils$8.getAllListeners(context);
  ...
  const utils$7 = new EventFunctionsUtils();
  function setupEventFunctions() {
      ...
      Object.defineProperty(TurboSelector.prototype, "boundListeners", {
          get: function () {
              return utils$7.getBoundListenersSet(this);
          },
          configurable: true,
          enumerable: true
      });
      ...
      Object.defineProperty(TurboSelector.prototype, "bypassManagerOn", {
          get: function () {
              return utils$7.data(this)["bypassCallback"];
          },
          set: function (value) {
              utils$7.data(this)["bypassCallback"] = value;
          },
          configurable: true,
          enumerable: true
      });
      ...
      TurboSelector.prototype.onTool = function _onTool(type, toolName, listener, options, manager = TurboEventManager.instance) {
          ...
          utils$7.getBoundListenersSet(this).addListener({
              target: this,
              type,
              toolName,
              callback: listener,
      ...
      TurboSelector.prototype.executeAction = function _executeAction(type, toolName, event, options, manager = TurboEventManager.instance) {
          ...
          if (this.bypassManagerOn)
              utils$7.bypassManager(this, manager, this.bypassManagerOn(event));
          ...
          const runListeners = (target, tool) => {
              ...
              const boundSet = utils$7.getBoundListenersSet(target);
              const entries = utils$7.getBoundListeners({ target, type, toolName: tool, options, manager });
              ...
              for (const entry of entries) {
                  if (firedListeners.has(entry))
                      continue;
                  try {
                      propagation = utils$7.processPropagation(entry.executeOn(event, ts), propagation);
                  }
                  finally {
      ...
      TurboSelector.prototype.hasToolListener = function _hasToolListener(type, toolName, listener, manager = TurboEventManager.instance) {
          return utils$7.getBoundListeners({ target: this, callback: listener, type, toolName, manager }).length > 0;
      };
      /**
      ...
      TurboSelector.prototype.hasListenersByType = function _hasListenersByType(type, toolName, manager = TurboEventManager.instance) {
          return utils$7.getBoundListeners({ target: this, type, toolName, manager }).length > 0;
      };
      /**
      ...
      TurboSelector.prototype.removeToolListener = function _removeToolListener(type, toolName, listener, manager = TurboEventManager.instance) {
          utils$7.getBoundListenersSet(this).removeMatchingListeners({ target: this, type, toolName, callback: listener, manager });
          return this;
      };
      /**
      ...
      TurboSelector.prototype.removeListenersByType = function _removeListenersByType(type, toolName, manager = TurboEventManager.instance) {
          utils$7.getBoundListenersSet(this).removeMatchingListeners({ target: this, type, toolName, manager });
          return this;
      };
      /**
      ...
      TurboSelector.prototype.removeAllListeners = function _removeListeners(manager = TurboEventManager.instance) {
          utils$7.getBoundListenersSet(this).removeMatchingListeners({ manager });
          return this;
      };
      /**
      ...
      TurboSelector.prototype.preventDefault = function _preventDefault(options) {
          ...
          utils$7.data(this.element).preventDefaultOn = options.preventDefaultOn
              ?? utils$7.data(this.element).preventDefaultOn ?? (() => true);
          const preventDefaultListeners = utils$7.getPreventDefaultListeners(this);
          ...
          for (const type of new Set(types)) {
              const handler = (event) => {
                  if (!utils$7.data(this.element).preventDefaultOn(type, event))
                      return false;
  ...
  const utils$6 = new StyleFunctionsUtils();
  function setupStyleFunctions() {
      ...
      TurboSelector.prototype.setStyle = function _setStyle(attribute, value, instant = false) {
          ...
          if (!(this.element instanceof HTMLElement) && !(this.element instanceof SVGElement))
              return this;
          utils$6.setStyle(this, attribute, value, instant);
          return this;
      };
      /**
       * @description Set a certain style attribute of the element to the provided value.
      ...
      TurboSelector.prototype.appendStyle = function _appendStyle(attribute, value, separator = ", ", instant = false) {
          ...
          utils$6.setStyle(this, attribute, currentStyle + separator + value, instant);
          return this;
      };
      /**
      ...
      TurboSelector.prototype.setStyles = function _setStyles(styles, instant = false) {
          ...
          Object.entries(stylesObject).forEach(([key, value]) => utils$6.setStyle(this, key, value, instant, false));
          if (!instant)
              utils$6.applyStyles(this);
          return this;
      };
  }
  ...
  const utils$5 = new ToolFunctionsUtils();
  function setupToolFunctions() {
      ...
      TurboSelector.prototype.makeTool = function _makeTool(toolName, options) {
          ...
          utils$5.saveTool(this, toolName, options.manager);
          if (options.onActivate)
              utils$5.getActivationDelegate(this, toolName, options.manager).add(options.onActivate);
          if (options.onDeactivate)
              utils$5.getDeactivationDelegate(this, toolName, options.manager).add(options.onDeactivate);
          return this;
      };
      TurboSelector.prototype.isTool = function _isTool(manager = TurboEventManager.instance) {
          return utils$5.getToolNames(this.element, manager).length > 0;
      };
      TurboSelector.prototype.getToolNames = function _getToolName(manager = TurboEventManager.instance) {
          return utils$5.getToolNames(this.element, manager);
      };
      TurboSelector.prototype.getToolName = function _getToolName(manager = TurboEventManager.instance) {
          const toolNames = utils$5.getToolNames(this.element, manager);
      ...
      TurboSelector.prototype.onToolActivate = function _onActivate(toolName, manager = TurboEventManager.instance) {
          ...
          return utils$5.getActivationDelegate(this, toolName, manager);
      };
      TurboSelector.prototype.onToolDeactivate = function _onDeactivate(toolName, manager = TurboEventManager.instance) {
          if (!toolName)
              toolName = this.getToolName(manager);
          return utils$5.getDeactivationDelegate(this, toolName, manager);
      };
      /*
       *
      ...
      TurboSelector.prototype.addToolBehavior = function _addToolBehavior(type, callback, toolName = this.getToolName(), manager = TurboEventManager.instance) {
          if (type && toolName) {
              manager.setupCustomDispatcher?.(type);
              utils$5.addToolBehavior(toolName, type, callback, manager);
          }
          return this;
      };
      TurboSelector.prototype.hasToolBehavior = function _hasToolBehavior(type, toolName = this.getToolName(), manager = TurboEventManager.instance) {
          if (!type || !toolName)
              return false;
          return utils$5.getToolBehaviors(toolName, type, manager).length > 0;
      };
      ...
      TurboSelector.prototype.embedTool = function _embedTool(target, manager = TurboEventManager.instance) {
          if (this.isTool(manager))
              utils$5.setEmbeddedToolTarget(this.element, target, manager);
          return this;
      };
      TurboSelector.prototype.isEmbeddedTool = function _isEmbeddedTool(manager = TurboEventManager.instance) {
          return !!utils$5.getEmbeddedToolTarget(this.element, manager);
      };
      ...
      TurboSelector.prototype.applyTool = function _applyTool(toolName, type, event, manager = TurboEventManager.instance) {
          let propagation = Propagation.propagate;
          const behaviors = utils$5.getToolBehaviors(toolName, type, manager);
          const options = {};
          options.embeddedTarget = utils$5.getEmbeddedToolTarget(this.element, manager);
          options.isEmbedded = !!options.embeddedTarget;
          for (const behavior of behaviors) {
              propagation = utils$5.processPropagation(behavior.executeOn(event, this.element, options), propagation, Propagation.propagate);
              if (propagation === Propagation.stopImmediatePropagation)
                  break;
          }
          return propagation;
      ...
      TurboSelector.prototype.ignoreTool = function _ignoreTool(toolName, type, ignore = true, manager = TurboEventManager.instance) {
          utils$5.ignoreTool(this.element, toolName, type, ignore, manager);
          return this;
      };
      TurboSelector.prototype.ignoreAllTools = function _ignoreAllTools(ignore = true, manager = TurboEventManager.instance) {
          utils$5.getElementData(this.element, manager).ignoreAllTools = ignore;
          return this;
      };
      TurboSelector.prototype.isToolIgnored = function _isToolIgnored(toolName, type, manager = TurboEventManager.instance) {
          if (utils$5.getElementData(this.element, manager).ignoreAllTools)
              return true;
          return utils$5.isToolIgnored(this.element, toolName, type, manager);
      };
  }
  ...
  function setupSubstrateFunctions() {
      ...
      Object.defineProperty(TurboSelector.prototype, "activeSubstrates", {
          get: function () {
              return utils$4.getActiveSubstrates(this.element);
          },
          configurable: false,
          enumerable: true
      });
      TurboSelector.prototype.activateSubstrate = function _activateSubstrates(...substrates) {
          const targets = substrates.length ? substrates : [utils$4.getDefaultSubstrate(this)];
      ...
      TurboSelector.prototype.deactivateSubstrate = function _deactivateSubstrates(...substrates) {
          ...
          targets.forEach(substrate => {
              if (substrate)
                  utils$4.activate(this, substrate, false);
          });
          return this;
      };
      TurboSelector.prototype.toggleSubstrate = function _toggleSubstrates(substrate = utils$4.getDefaultSubstrate(this), force) {
          if (substrate)
              utils$4.activate(this, substrate, force);
          return this;
      };
      TurboSelector.prototype.activateOnlySubstrate = function _activateOnlySubstrates(substrate = utils$4.getDefaultSubstrate(this)) {
          if (substrate)
              utils$4.getSubstrates(this).forEach(subs => utils$4.activate(this, substrate, substrate === subs));
          return this;
      };
      TurboSelector.prototype.activateAllSubstrates = function _activateAllSubstrates() {
          utils$4.getSubstrates(this).forEach(substrate => utils$4.activate(this, substrate, true));
          return this;
      };
      TurboSelector.prototype.deactivateAllSubstrates = function _deactivateAllSubstrates() {
          utils$4.getSubstrates(this).forEach(substrate => utils$4.activate(this, substrate, false));
          return this;
      };
      TurboSelector.prototype.onSubstrateActivate = function _onSubstrateActivate(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getSubstrateData(this, substrate)?.onActivate ?? new Delegate();
      };
      TurboSelector.prototype.onSubstrateDeactivate = function _onSubstrateDeactivate(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getSubstrateData(this, substrate)?.onDeactivate ?? new Delegate();
      };
      //PRIORITY
      TurboSelector.prototype.getSubstratePriority = function _getSubstratePriority(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getField(this, substrate, "priority") ?? 0;
      };
      TurboSelector.prototype.setSubstratePriority = function _setSubstratePriority(priority, substrate = utils$4.getDefaultSubstrate(this)) {
          if (typeof priority === "number")
              utils$4.setField(this, substrate, "priority", priority);
          return this;
      };
      //OBJECT LIST
      TurboSelector.prototype.getSubstrateObjectList = function _getSubstrateObjectList(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getField(this, substrate, "objectList") ?? new TurboNodeList();
      };
      TurboSelector.prototype.onSubstrateObjectListChange = function _onSubstrateObjectListChange(substrate) {
          return utils$4.getSubstrateData(this, substrate).objectsChangedDelegate;
      };
      //TRIGGER LIST
      TurboSelector.prototype.getSubstrateTriggerList = function _getSubstrateTriggerList(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getField(this, substrate, "triggerList") ?? new TurboNodeList();
      };
      //QUEUE
      TurboSelector.prototype.getSubstrateQueue = function _getSubstrateQueue(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getSubstrateData(this, substrate).queue;
      };
      TurboSelector.prototype.getDefaultSubstrateQueue = function _getDefaultSubstrateQueue(substrate = utils$4.getDefaultSubstrate(this)) {
          const queue = utils$4.getField(this, substrate, "defaultQueue");
      ...
      TurboSelector.prototype.setDefaultSubstrateQueue = function _setDefaultSubstrateQueue(queue, substrate = utils$4.getDefaultSubstrate(this)) {
          if (!queue || typeof queue !== "object")
              return this;
          if (Array.isArray(queue))
              queue = new TurboQueue().push(...queue);
          if (queue instanceof TurboQueue)
              utils$4.setField(this, substrate, "defaultQueue", queue.clone());
          return this;
      };
      //PASSES
      TurboSelector.prototype.getObjectPassesForSubstrate = function _getObjectPassesForSubstrate(object, substrate = utils$4.getDefaultSubstrate(this)) {
          if (!object)
              return 0;
          const map = utils$4.getSubstrateData(this, substrate).passes;
          if (!map || !(map instanceof WeakMap))
              return 0;
          return map.get(object) ?? 0;
      };
      TurboSelector.prototype.getMaxPassesForSubstrate = function _getMaxPassesForSubstrate(substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getField(this, substrate, "maxPasses");
      };
      TurboSelector.prototype.setMaxPassesForSubstrate = function _setMaxPassesForSubstrate(passes, substrate = utils$4.getDefaultSubstrate(this)) {
          utils$4.setField(this, substrate, "maxPasses", passes);
          return this;
      };
      //CUSTOM DATA
      TurboSelector.prototype.getObjectDataForSubstrate = function _getObjectDataForSubstrate(object, substrate = utils$4.getDefaultSubstrate(this)) {
          return utils$4.getCustomData(this.element, substrate, object);
      };
      TurboSelector.prototype.setObjectDataForSubstrate = function _setObjectDataForSubstrate(object, data, substrate = utils$4.getDefaultSubstrate(this)) {
          if (!data || typeof data !== "object")
              data = {};
          utils$4.getSubstrateData(this.element, substrate).customData.set(object, data);
          return this;
      };
      //CHECKER
      TurboSelector.prototype.addChecker = function _addChecker(properties) {
          if (!properties || !properties.name || !properties.callback)
              return this;
          const substrate = properties.substrate || utils$4.getDefaultSubstrate(this);
          utils$4.getSubstrateData(this, substrate).checkers?.set(properties.name, properties.callback);
          return this;
      };
      TurboSelector.prototype.removeChecker = function _removeChecker(name, substrate = utils$4.getDefaultSubstrate(this)) {
          utils$4.getSubstrateData(this, substrate).checkers?.delete(name);
          return this;
      };
      TurboSelector.prototype.clearCheckers = function _clearCheckers(substrate = utils$4.getDefaultSubstrate(this)) {
          utils$4.getSubstrateData(this, substrate).checkers?.clear();
          return this;
      };
      TurboSelector.prototype.checkSubstrate = function _checkSubstrate(properties) {
          if (!properties)
              properties = {};
          utils$4.setupSubstrateCallbackProperties(this, properties);
          if (!properties.substrate)
              return true;
          const substrate = properties.substrate || utils$4.getDefaultSubstrate(this);
          for (const checker of utils$4.getSubstrateData(this, substrate).checkers.values()) {
      ...
      TurboSelector.prototype.checkSubstratesForEvent = function _checkSubstratesForEvent(properties) {
          if (!properties || !properties.event)
              return true;
          utils$4.setupSubstrateCallbackProperties(null, properties);
          if (!properties.eventTarget || typeof properties.eventTarget !== "object") {
              properties.eventTarget = this.element;
              if (!properties.eventTarget || typeof properties.eventTarget !== "object")
                  return true;
          }
          const substratesData = utils$4.getSubstratesTriggeredByObjects(properties.eventTarget);
      ...
      TurboSelector.prototype.addMutator = function _addMutator(properties) {
          if (!properties || !properties.name || !properties.callback)
              return this;
          const substrate = properties.substrate || utils$4.getDefaultSubstrate(this);
          utils$4.getSubstrateData(this, substrate).mutators?.set(properties.name, properties.callback);
          return this;
      };
      TurboSelector.prototype.removeMutator = function _removeMutator(name, substrate = utils$4.getDefaultSubstrate(this)) {
          utils$4.getSubstrateData(this, substrate).mutators?.delete(name);
          return this;
      };
      TurboSelector.prototype.clearMutators = function _clearMutators(substrate = utils$4.getDefaultSubstrate(this)) {
          utils$4.getSubstrateData(this, substrate).mutators?.clear();
          return this;
      };
      TurboSelector.prototype.mutate = function _mutate(properties) {
          ...
          if (!properties.substrate)
              return this;
          const mutation = utils$4.getSubstrateData(this, properties.substrate).mutators?.get(properties.mutation);
          if (mutation)
      ...
      TurboSelector.prototype.addSolver = function _addSolver(properties) {
          ...
          const substrate = properties.substrate ?? utils$4.getDefaultSubstrate(this);
          const data = utils$4.getSubstrateData(this, substrate);
          if (!data)
              return this;
      ...
      TurboSelector.prototype.removeSolver = function _removeSolver(name, substrate = utils$4.getDefaultSubstrate(this)) {
          const data = utils$4.getSubstrateData(this, substrate);
          if (!data)
              return this;
      ...
      TurboSelector.prototype.clearSolvers = function _clearSolvers(substrate = utils$4.getDefaultSubstrate(this)) {
          const data = utils$4.getSubstrateData(this, substrate);
          if (!data)
              return this;
          data.solvers?.clear();
      ...
      TurboSelector.prototype.solveSubstrate = function _solveSubstrate(properties = {}) {
          ...
          if (!properties.substrate)
              return this;
          const data = utils$4.getSubstrateData(this, properties.substrate);
          if (!data)
              return this;
          utils$4.solveSubstrateInternal({ data, host: this.element, name: properties.substrate }, properties);
          return this;
      };
      TurboSelector.prototype.solveSubstratesForEvent = function _solveSubstratesForEvent(properties) {
          ...
          const substratesData = utils$4.getSubstratesTriggeredByObjects(properties.eventTarget);
          for (const substrateData of substratesData)
              utils$4.solveSubstrateInternal(substrateData, properties);
          return this;
      };
  }
  ...
  const utils$3 = new ReifectFunctionsUtils();
  ...
  function setupReifectFunctions() {
      ...
      Object.defineProperty(TurboSelector.prototype, "reifects", {
          get: function () {
              if (!this.element)
                  return new Set();
              return new Set(utils$3.data(this.element).reifects?.toArray());
          },
          configurable: false,
          enumerable: true
      });
      Object.defineProperty(TurboSelector.prototype, "onTransitionStart", {
          get: function () {
              return utils$3.data(this.element).onTransitionStart;
          },
          configurable: false,
          enumerable: true
      });
      Object.defineProperty(TurboSelector.prototype, "onTransitionEnd", {
          get: function () {
              return utils$3.data(this.element).onTransitionEnd;
          },
          configurable: false,
          enumerable: true
      });
      ...
      Object.defineProperty(TurboSelector.prototype, "showTransition", {
          get: function () {
              if (!this.element)
                  return;
              const data = utils$3.data(this.element);
          ...
          set: function (value) {
              if (!this.element)
                  return;
              utils$3.data(this.element).showTransition = value;
          },
          configurable: true,
          enumerable: true
      });
      ...
      TurboSelector.prototype.attachReifect = function _attachReifect(...reifects) {
          ...
          reifects.forEach(entry => {
              if (this.reifects.has(entry))
                  return;
              utils$3.attachReifect(this.element, entry);
      ...
      TurboSelector.prototype.detachReifect = function _detachReifect(...reifects) {
          ...
          reifects.forEach(entry => {
              if (!this.reifects.has(entry))
                  return;
              utils$3.detachReifect(this.element, entry);
      ...
      TurboSelector.prototype.reifectEnabledState = function _reifectEnabledState(reifect) {
          ...
          return utils$3.data(this.element).enabled;
      };
      TurboSelector.prototype.enableReifect = function _enableReifect(value, reifect) {
          ...
          const enabled = utils$3.data(this.element).enabled;
          if (typeof value === "boolean")
  ...
  class RegisterUtils {
      registry = new Map();
      constructor() {
          for (const category of Object.values(RegistryCategory))
              this.registry.set(category, new Map());
      }
      inferCategory(constructor) {
          const proto = constructor.prototype;
          if (proto instanceof TurboElement)
              return RegistryCategory.TurboElement;
          if (proto instanceof TurboBaseElement)
              return RegistryCategory.TurboBaseElement;
          if (proto instanceof TurboHeadlessElement)
              return RegistryCategory.TurboHeadlessElement;
          if (proto instanceof TurboProxiedElement)
              return RegistryCategory.TurboProxiedElement;
          if (proto instanceof HTMLElement)
              return RegistryCategory.HTMLElement;
          if (proto instanceof SVGElement)
              return RegistryCategory.SVGElement;
          if (proto instanceof MathMLElement)
          ...
          if (proto instanceof TurboModel)
              return RegistryCategory.TurboModel;
          if (proto instanceof TurboView)
              return RegistryCategory.TurboView;
          if (proto instanceof TurboEmitter)
              return RegistryCategory.TurboEmitter;
          if (proto instanceof TurboController)
              return RegistryCategory.TurboController;
          if (proto instanceof TurboHandler)
              return RegistryCategory.TurboHandler;
          if (proto instanceof TurboInteractor)
              return RegistryCategory.TurboInteractor;
          if (proto instanceof TurboTool)
              return RegistryCategory.TurboTool;
          if (proto instanceof TurboSubstrate)
              return RegistryCategory.TurboSubstrate;
          return RegistryCategory.Other;
      }
      register(constructor, category, name) {
          const resolvedCategory = category ?? this.inferCategory(constructor);
          const resolvedName = name ?? constructor.name;
          const entry = { constructor, category: resolvedCategory, name: resolvedName };
          this.registry.get(resolvedCategory).set(resolvedName, entry);
      }
  }

  const utils$2 = new RegisterUtils();
  function register(...args) {
      if (typeof args[0] === "function") {
          const [Base, category, name] = args;
          utils$2.register(Base, category, name);
          return;
      }
      const [category, name] = args;
      return function (Base, context) {
          context.addInitializer(function () {
              utils$2.register(Base, category, name ?? String(context.name));
          });
          return Base;
      };
  }
  ...
  function define(...args) {
      if (typeof args[0] === "function") {
          const [Base, elementName, options] = args;
          return applyDefine(Base, elementName, options);
      }
      const [elementName, options] = args;
      return function (Base, context) {
          return applyDefine(Base, elementName ?? camelToKebabCase(context.name), options, context);
      };
  }
  function applyDefine(Base, elementName, options = { injectAttributeBridge: true }, context) {
      const name = elementName ?? (context ? camelToKebabCase(context.name) : camelToKebabCase(Base.name));
      ...
      if (typeof Base["create"] === "function" && !utils$1.prototype(Base.prototype).wrappedCreate) {
          utils$1.prototype(Base.prototype).wrappedCreate = true;
  ...
  let TurboPopup = (() => {
      ...
      var TurboPopup = class extends _classSuper {
          ...
          anchor = (__runInitializers(this, _instanceExtraInitializers), document.body);
   ...
   */
  (() => {
      let _classDecorators = [define("turbo-button-popup")];
      let _classDescriptor;
      let _classExtraInitializers = [];
      let _classThis;
