(function () {
      ...
      return function (value, context) {
          ...
          context.addInitializer(function () {
              ...
              if (kind === "field" || kind === "accessor") {
                  ...
                  const installed = utils$c.constructorData(prototype).installed;
  ...
  const utils$b = new HierarchyFunctionsUtils();
      ...
      Object.defineProperty(TurboSelector.prototype, "childHandler", {
          set: function (value) {
              if (value instanceof TurboSelector)
                  value = value.element;
              utils$b.data(this).childHandler = value;
          },
          get: function () {
              const childHandler = utils$b.data(this).childHandler;
              if (childHandler)
                  return childHandler;
  ...
  const utils$a = new ClassFunctionsUtils();
  function setupClassFunctions() {
      ...
      TurboSelector.prototype.addClass = function _addClass(classes) {
          if (!(this.element instanceof Element))
              return this;
          return utils$a.operateOnClasses(this, classes, entry => this.element.classList.add(entry));
      };
      /**
      ...
      TurboSelector.prototype.removeClass = function _removeClass(classes) {
          if (!(this.element instanceof Element))
              return this;
          return utils$a.operateOnClasses(this, classes, entry => this.element.classList.remove(entry));
      };
      /**
      ...
      TurboSelector.prototype.toggleClass = function _toggleClass(classes, force) {
          if (!(this.element instanceof Element))
              return this;
          return utils$a.operateOnClasses(this, classes, entry => this.element.classList.toggle(entry, force));
      };
      /**
  ...
  ***************************************************************************** */
  ...
  let TurboModel = (() => {
      ...
      return class TurboModel {
          static {
              ...
              __esDecorate$1(this, null, _bubbleChanges_decorators, { kind: "accessor", name: "bubbleChanges", static: false, private: false, access: { has: obj => "bubbleChanges" in obj, get: obj => obj.bubbleChanges, set: (obj, value) => { obj.bubbleChanges = value; } }, metadata: _metadata }, _bubbleChanges_initializers, _bubbleChanges_extraInitializers);
          ...
          #bubbleChanges_accessor_storage = (__runInitializers$1(this, _enabledCallbacks_extraInitializers), __runInitializers$1(this, _bubbleChanges_initializers, void 0));
          /**
  ...
  const utils$8 = new ElementFunctionsUtils();
  function setupElementFunctions() {
      ...
      TurboSelector.prototype.setProperties = function _setProperties(properties = {}, setOnlyBaseProperties = false) {
          ...
          if (!!properties.shadowDOM)
              this["shadowDOM"] = properties.shadowDOM;
      ...
      TurboSelector.prototype.feedforward = function _feedforward(properties = {}) {
          ...
          const feedforwardElements = utils$8.data(this.element).feedforwardElements;
      ...
      Object.defineProperty(TurboSelector.prototype, "defaultFeedforwardProperties", {
          get: function () {
              ...
              return utils$8.data(this.element).defaultFeedforwardProperties;
          },
          set: function (value) {
              if ("defaultFeedforwardProperties" in this.element)
                  this.element.defaultFeedforwardProperties = value;
              utils$8.data(this.element).defaultFeedforwardProperties = value;
          },
          configurable: true,
          enumerable: true
      });
  ...
  class TurboHeadlessElement {
      ...
      mvc;
      constructor(properties = {}) {
          turbo(properties).applyDefaults(this.constructor["defaultProperties"] ?? {});
          this.mvc = new Mvc({ ...properties, element: this });
          //TODO apply also on this element itself
  ...
  function setupEventFunctions() {
      ...
      TurboSelector.prototype.onTool = function _onTool(type, toolName, listener, options, manager = TurboEventManager.instance) {
          ...
          utils$6.getBoundListenersSet(this).addListener({
              target: this,
              type,
              toolName,
              callback: listener,
      ...
      TurboSelector.prototype.hasToolListener = function _hasToolListener(type, toolName, listener, manager = TurboEventManager.instance) {
          return utils$6.getBoundListeners({ target: this, callback: listener, type, toolName, manager }).length > 0;
      };
      /**
      ...
      TurboSelector.prototype.hasListenersByType = function _hasListenersByType(type, toolName, manager = TurboEventManager.instance) {
          return utils$6.getBoundListeners({ target: this, type, toolName, manager }).length > 0;
      };
      /**
      ...
      TurboSelector.prototype.removeToolListener = function _removeToolListener(type, toolName, listener, manager = TurboEventManager.instance) {
          utils$6.getBoundListenersSet(this).removeMatchingListeners({ target: this, type, toolName, callback: listener, manager });
          return this;
      };
      /**
      ...
      TurboSelector.prototype.removeListenersByType = function _removeListenersByType(type, toolName, manager = TurboEventManager.instance) {
          utils$6.getBoundListenersSet(this).removeMatchingListeners({ target: this, type, toolName, manager });
          return this;
      };
      /**
      ...
      TurboSelector.prototype.removeAllListeners = function _removeListeners(manager = TurboEventManager.instance) {
          utils$6.getBoundListenersSet(this).removeMatchingListeners({ manager });
          return this;
      };
      /**
  ...
  let TurboNodeList = (() => {
      ...
      return class TurboNodeList {
          ...
          slots = (__runInitializers$1(this, _instanceExtraInitializers), []);
  ...
  function setupSubstrateFunctions() {
      TurboSelector.prototype.makeSubstrate = function _makeSubstrate(substrate, options) {
          ...
          if (options?.attachedInstance)
              utils$3.getSubstrateData(this, substrate).attachedInstance = options.attachedInstance;
      ...
      TurboSelector.prototype.activateSubstrate = function _activateSubstrates(...substrates) {
          const targets = substrates.length ? substrates : [utils$3.getDefaultSubstrate(this)];
      ...
      TurboSelector.prototype.deactivateSubstrate = function _deactivateSubstrates(...substrates) {
          ...
          targets.forEach(substrate => {
              if (substrate)
                  utils$3.activate(this, substrate, false);
          });
          return this;
      };
      TurboSelector.prototype.toggleSubstrate = function _toggleSubstrates(substrate = utils$3.getDefaultSubstrate(this), force) {
          if (substrate)
              utils$3.activate(this, substrate, force);
          return this;
      };
      TurboSelector.prototype.activateOnlySubstrate = function _activateOnlySubstrates(substrate = utils$3.getDefaultSubstrate(this)) {
          if (substrate)
              utils$3.getSubstrates(this).forEach(subs => utils$3.activate(this, substrate, substrate === subs));
          return this;
      };
      TurboSelector.prototype.activateAllSubstrates = function _activateAllSubstrates() {
          utils$3.getSubstrates(this).forEach(substrate => utils$3.activate(this, substrate, true));
          return this;
      };
      TurboSelector.prototype.deactivateAllSubstrates = function _deactivateAllSubstrates() {
          utils$3.getSubstrates(this).forEach(substrate => utils$3.activate(this, substrate, false));
          return this;
      };
      ...
      TurboSelector.prototype.getSubstratePriority = function _getSubstratePriority(substrate = utils$3.getDefaultSubstrate(this)) {
          return utils$3.getField(this, substrate, "priority") ?? 0;
      };
      TurboSelector.prototype.setSubstratePriority = function _setSubstratePriority(priority, substrate = utils$3.getDefaultSubstrate(this)) {
          if (typeof priority === "number")
              utils$3.setField(this, substrate, "priority", priority);
          return this;
      };
      //OBJECT LIST
      ...
      TurboSelector.prototype.setDefaultSubstrateQueue = function _setDefaultSubstrateQueue(queue, substrate = utils$3.getDefaultSubstrate(this)) {
          ...
          if (queue instanceof TurboQueue)
              utils$3.setField(this, substrate, "defaultQueue", queue.clone());
          return this;
      };
      //PASSES
      ...
      TurboSelector.prototype.getMaxPassesForSubstrate = function _getMaxPassesForSubstrate(substrate = utils$3.getDefaultSubstrate(this)) {
          return utils$3.getField(this, substrate, "maxPasses");
      };
      TurboSelector.prototype.setMaxPassesForSubstrate = function _setMaxPassesForSubstrate(passes, substrate = utils$3.getDefaultSubstrate(this)) {
          utils$3.setField(this, substrate, "maxPasses", passes);
          return this;
      };
      //CUSTOM DATA
  ...
  let StatefulReifect = (() => {
      ...
      return class StatefulReifect {
          static {
              ...
              __esDecorate$1(this, null, _get_states_decorators, { kind: "getter", name: "states", static: false, private: false, access: { has: obj => "states" in obj, get: obj => obj.states }, metadata: _metadata }, null, _instanceExtraInitializers);
              ...
              __esDecorate$1(this, null, _set_replacedWithEnabled_decorators, { kind: "setter", name: "replacedWithEnabled", static: false, private: false, access: { has: obj => "replacedWithEnabled" in obj, set: (obj, value) => { obj.replacedWithEnabled = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
  ...
  let Color = (() => {
      ...
      return class Color {
          static {
              ...
              __esDecorate$1(this, null, _set_r_decorators, { kind: "setter", name: "r", static: false, private: false, access: { has: obj => "r" in obj, set: (obj, value) => { obj.r = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_g_decorators, { kind: "setter", name: "g", static: false, private: false, access: { has: obj => "g" in obj, set: (obj, value) => { obj.g = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_b_decorators, { kind: "setter", name: "b", static: false, private: false, access: { has: obj => "b" in obj, set: (obj, value) => { obj.b = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_a_decorators, { kind: "setter", name: "a", static: false, private: false, access: { has: obj => "a" in obj, set: (obj, value) => { obj.a = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_h_decorators, { kind: "setter", name: "h", static: false, private: false, access: { has: obj => "h" in obj, set: (obj, value) => { obj.h = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_s_decorators, { kind: "setter", name: "s", static: false, private: false, access: { has: obj => "s" in obj, set: (obj, value) => { obj.s = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_l_decorators, { kind: "setter", name: "l", static: false, private: false, access: { has: obj => "l" in obj, set: (obj, value) => { obj.l = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              __esDecorate$1(this, null, _set_hex_decorators, { kind: "setter", name: "hex", static: false, private: false, access: { has: obj => "hex" in obj, set: (obj, value) => { obj.hex = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
              if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
          }
          syncing = (__runInitializers$1(this, _instanceExtraInitializers), false);
          set r(value) {
              this.syncFromRgb();
          }
          set g(value) {
  ...
  let TurboIcon = (() => {
      ...
      (class extends _classSuper {
          ...
          static {
              ...
              __esDecorate$1(this, null, _get_iconColor_decorators, { kind: "getter", name: "iconColor", static: false, private: false, access: { has: obj => "iconColor" in obj, get: obj => obj.iconColor }, metadata: _metadata }, null, _instanceExtraInitializers);
          ...
          static defaultProperties = {
              ...TurboElement.defaultProperties,
              type: "svg"
          };
  ...
  let TurboInput = (() => {
      ...
      (class extends _classSuper {
          ...
          static defaultProperties = {
              ...TurboRichElement.defaultProperties,
              elementTag: "input"
          };
          static create(properties = {}) {
          ...
          #placeholder_accessor_storage = (__runInitializers$1(this, _type_extraInitializers), __runInitializers$1(this, _placeholder_initializers, void 0));
          get placeholder() { return this.#placeholder_accessor_storage; }
          set placeholder(value) { this.#placeholder_accessor_storage = value; }
          #pattern_accessor_storage = (__runInitializers$1(this, _placeholder_extraInitializers), __runInitializers$1(this, _pattern_initializers, void 0));
  ...
  class TurboBaseElement {
       ...
       */
      static defaultProperties = {};
      //TODO apply default properties on this element itself
      constructor(properties = {}) {
          queueMicrotask(() => {
              turbo(properties).applyDefaults(this.constructor["defaultProperties"] ?? {});
              for (let [property, value] of Object.entries(properties)) {
  ...
  let TurboSelect = (() => {
      ...
      return class TurboSelect extends _classSuper {
          ...
          static defaultProperties = { selectedEntriesClasses: "selected" };
          ...
          forceSelection = (__runInitializers$1(this, _createEntry_extraInitializers), __runInitializers$1(this, _forceSelection_initializers, void 0));
          set onSelect(value) {
              if (value)
          ...
          constructor(properties = {}) {
              ...
              super(properties);
              __runInitializers$1(this, _entriesClasses_extraInitializers);
              ...
              // turbo(this).applyDefaults(this.constructor["defaultProperties"] ?? {});
  ...
  let TurboSelectElement = (() => {
      ...
      (class extends _classSuper {
          ...
          static {
              ...
              __esDecorate$1(this, null, _forceSelection_decorators, { kind: "accessor", name: "forceSelection", static: false, private: false, access: { has: obj => "forceSelection" in obj, get: obj => obj.forceSelection, set: (obj, value) => { obj.forceSelection = value; } }, metadata: _metadata }, _forceSelection_initializers, _forceSelection_extraInitializers);
              __esDecorate$1(this, null, _enabledEntries_decorators, { kind: "accessor", name: "enabledEntries", static: false, private: false, access: { has: obj => "enabledEntries" in obj, get: obj => obj.enabledEntries, set: (obj, value) => { obj.enabledEntries = value; } }, metadata: _metadata }, _enabledEntries_initializers, _enabledEntries_extraInitializers);
              __esDecorate$1(this, null, _enabledValues_decorators, { kind: "accessor", name: "enabledValues", static: false, private: false, access: { has: obj => "enabledValues" in obj, get: obj => obj.enabledValues, set: (obj, value) => { obj.enabledValues = value; } }, metadata: _metadata }, _enabledValues_initializers, _enabledValues_extraInitializers);
              ...
              __esDecorate$1(this, null, _selectedValues_decorators, { kind: "accessor", name: "selectedValues", static: false, private: false, access: { has: obj => "selectedValues" in obj, get: obj => obj.selectedValues, set: (obj, value) => { obj.selectedValues = value; } }, metadata: _metadata }, _selectedValues_initializers, _selectedValues_extraInitializers);
          ...
          values = __runInitializers$1(this, _values_initializers, void 0);
          #selectedEntries_accessor_storage = (__runInitializers$1(this, _values_extraInitializers), __runInitializers$1(this, _selectedEntries_initializers, void 0));
          ...
          #inputField_accessor_storage = (__runInitializers$1(this, _inputName_extraInitializers), __runInitializers$1(this, _inputField_initializers, void 0));
          get inputField() { return this.#inputField_accessor_storage; }
          set inputField(value) { this.#inputField_accessor_storage = value; }
          #multiSelection_accessor_storage = (__runInitializers$1(this, _inputField_extraInitializers), __runInitializers$1(this, _multiSelection_initializers, void 0));
          ...
          #forceSelection_accessor_storage = (__runInitializers$1(this, _multiSelection_extraInitializers), __runInitializers$1(this, _forceSelection_initializers, void 0));
          ...
          #enabledEntries_accessor_storage = (__runInitializers$1(this, _forceSelection_extraInitializers), __runInitializers$1(this, _enabledEntries_initializers, void 0));
          ...
          #enabledValues_accessor_storage = (__runInitializers$1(this, _enabledEntries_extraInitializers), __runInitializers$1(this, _enabledValues_initializers, void 0));
          ...
          #enabledSecondaryValues_accessor_storage = (__runInitializers$1(this, _enabledValues_extraInitializers), __runInitializers$1(this, _enabledSecondaryValues_initializers, void 0));
          ...
          #selectedValue_accessor_storage = (__runInitializers$1(this, _enabledSecondaryValues_extraInitializers), __runInitializers$1(this, _selectedValue_initializers, void 0));
          ...
          #selectedValues_accessor_storage = (__runInitializers$1(this, _selectedValue_extraInitializers), __runInitializers$1(this, _selectedValues_initializers, void 0));
          ...
          #selectedSecondaryValues_accessor_storage = (__runInitializers$1(this, _selectedValues_extraInitializers), __runInitializers$1(this, _selectedSecondaryValues_initializers, void 0));
          ...
          #selectedSecondaryValue_accessor_storage = (__runInitializers$1(this, _selectedSecondaryValues_extraInitializers), __runInitializers$1(this, _selectedSecondaryValue_initializers, void 0));
  ...
  let TurboDropdown = (() => {
      ...
      (class extends _classSuper {
          ...
          static defaultProperties = {
              ...TurboSelectElement.defaultProperties,
              selectorTag: "h4",
          };
          select = (__runInitializers$1(this, _instanceExtraInitializers), new TurboSelect({
          ...
          constructor() {
              super(...arguments);
              __runInitializers$1(this, _popupClasses_extraInitializers);
          }
          static {
              __runInitializers$1(_classThis, _classExtraInitializers);
          }
  ...
  (() => {
      ...
      (class extends _classSuper {
          ...
          popupClasses = __runInitializers$1(this, _popupClasses_initializers, void 0);
          /**
           * The dropdown's popup element.
           */
          set popup(value) {
  ...
  ***************************************************************************** */
  ...
  let DemoBox = (() => {
      ...
      (class extends _classSuper {
          ...
          static {
              ...
              _updateLabel_decorators = [effect];
  ...
  function richTest6() {
      ...
      const left = TurboIcon.create({ icon: "chevron-left", type: "svg" });
      const right = TurboIcon.create({ icon: "chevron-top", type: "svg" });
      const r = TurboRichElement.create({
  ...
  function selectTest4() {
      ...
      sel.createEntry = (num) => {
          const e = TurboRichElement.create({ text: `Item ${num}` });
  ...
  function selectTest5() {
      ...
      const sel = new TurboSelect({ parent: host });
      // Start with two
  ...
  function selectTest6() {
      ...
      boxEl.addSubBox("host", host)
          .addContent(TurboButton.create({ text: "Disable Green", onClick: () => sel.enable(false, g) }))
          .addContent(TurboButton.create({ text: "Enable Green", onClick: () => sel.enable(true, g) }))
  ...
  function drawerTest2_OverflowVsTransform() {
      ...
      box("TurboDrawer — hideOverflow vs transform")
          .addSubBox("hideOverflow = true", overflow, TurboButton.create({ text: "Open", onClick: () => (overflow.open = true) }), TurboButton.create({ text: "Close", onClick: () => (overflow.open = false) }))
          .addSubBox("hideOverflow = false", transform, TurboButton.create({ text: "Open", onClick: () => (transform.open = true) }), TurboButton.create({ text: "Close", onClick: () => (transform.open = false) }));
  }
  ...
  function drawerTest4_IconBehavior() {
      ...
      box("TurboDrawer — icon modes")
          .addSubBox("Append side to icon name", byName, TurboButton.create({ text: "Toggle", onClick: () => (byName.open = !byName.open) }), TurboButton.create({
          text: "Cycle side",
          onClick: () => {
          ...
          .addSubBox("Rotate icon based on side", byRotate, TurboButton.create({ text: "Toggle", onClick: () => (byRotate.open = !byRotate.open) }), TurboButton.create({
          text: "Cycle side",
          onClick: () => {
              const order = [Side.left, Side.top, Side.right, Side.bottom];
  ...
  function drawerTest5_LiveSideChanges() {
      ...
      box("TurboDrawer — live side changes")
          .addSubBox("Drawer", d, TurboButton.create({ text: "Open/Close", onClick: () => (d.open = !d.open) }), TurboButton.create({ text: "Side: Left", onClick: () => (d.side = Side.left) }), TurboButton.create({ text: "Side: Right", onClick: () => (d.side = Side.right) }), TurboButton.create({ text: "Side: Top", onClick: () => (d.side = Side.top) }), TurboButton.create({ text: "Side: Bottom", onClick: () => (d.side = Side.bottom) }));
  }
  function drawerTest6_ResizeObserver() {
      ...
      box("TurboDrawer — content resize")
          .addSubBox("Resize on content change", d, TurboButton.create({
          text: "Add line",
          onClick: () => {
              lines += 1;
  ...
  function drawerTest7_Nested() {
      ...
      box("TurboDrawer — nested")
          .addSubBox("Outer + Inner", outer, TurboButton.create({ text: "Toggle outer", onClick: () => (outer.open = !outer.open) }), TurboButton.create({ text: "Toggle inner", onClick: () => (inner.open = !inner.open) }));
  }
  function drawerTest8_RaceProps() {
      ...
      box("TurboDrawer — stress/race")
          .addSubBox("Racer", racer, TurboButton.create({
          text: "Go!",
          onClick: () => {
  ...
  function ddTestTabs() {
      ...
      const entries = tabs.map(t => TurboRichElement.create({ text: t.label, leftIcon: "chevron-left" }));
